...
module.exports = {
  ...
  theme: {
    ...
    extend: {
      ...
      fontSize: {
        h0_mobile: ["2.25rem", { lineHeight: "2.625rem", letterSpacing: "-0.01em", fontWeight: "600" }],
        h1_mobile: ["1.875rem", { lineHeight: "2.375rem", letterSpacing: "-0.01em", fontWeight: "600" }],
        h2_mobile: ["1.5rem", { lineHeight: "2rem", letterSpacing: "-0.01em", fontWeight: "600" }],
        h3_mobile: ["1.5rem", { lineHeight: "2rem", letterSpacing: "-0.01em", fontWeight: "600" }],
        h5_mobile: ["1.5rem", { lineHeight: "2rem", letterSpacing: "0", fontWeight: "600" }],
        h6_mobile: ["1.125rem", { lineHeight: "1.5rem", letterSpacing: "0", fontWeight: "600" }],
        h0_plain: ["3.75rem", { lineHeight: "4rem", letterSpacing: "-0.0375rem", fontWeight: "500" }],
        h0: ["4.5rem", { lineHeight: "4.625rem", letterSpacing: "-0.01em", fontWeight: "500" }],
        h1: ["3rem", { lineHeight: "3.375rem", letterSpacing: "-0.01em", fontWeight: "600" }],
        h2: ["2.25rem", { lineHeight: "2.625rem", letterSpacing: "-0.01em", fontWeight: "600" }],
        h3: ["1.875rem", { lineHeight: "2.375rem", letterSpacing: "-0.01em", fontWeight: "600" }],
        h4: ["1.5rem", { lineHeight: "2.125rem", letterSpacing: "-0.01em", fontWeight: "600" }],
        h5: ["1.125rem", { lineHeight: "1.75rem", letterSpacing: "-0.01em", fontWeight: "600" }],
        h6: ["0.875rem", { lineHeight: "1.125rem", letterSpacing: "-0.01em", fontWeight: "600" }],
        section: ["2.5rem", { lineHeight: "3rem", letterSpacing: "-0.01em", fontWeight: "600" }],
        ...
        body_article: ["1.25rem", { lineHeight: "2.375rem", fontWeight: "400" }],
        ...
        body_teaser: ["1.125rem", { lineHeight: "1.75rem", letterSpacing: "-0.01em", fontWeight: "400" }],
        ...
        barometer_title: ["1.125rem", { lineHeight: "1.75rem", fontWeight: "600" }],
        widget_title: ["2.25rem", { lineHeight: "1.1", fontWeight: "600" }],
        widget_amount: ["2.25rem", { lineHeight: "2.625rem", fontWeight: "600" }],
      ...
      colors: {
        brand: { 100: "#001DB2", 200: "#000833", 300: "#F5F6FF", 400: "#FFFFFF" },
        text_color: { 100: "#000833", 200: "#969696", 300: "#FFFFFF" },
        ui: { 100: "#E6E6E6", 200: "#D2D2D2", 300: "#BEBEBE", 400: "#969696", 500: "#646464", 600: "#C2CCFF" },
        ...
        blocks: {
          ...
          slider: { bg_light: "#F5F6FF", bg_dark: "#001DB2", text_light: "#000833", text_dark: "#FFFFFF" },
          footer_nav: { text: "#fff" },
        },
        error: "#D23E44",
        success: "#74CD9D",
        ...
        findock: { placeholder: "#757575", checkable_bg_color: "#FFF", checkable_hover_bg_color: "#F8F8F8", label_selected_color: "#F5F7FA", label_selected_bg_color: "#F5F6FF" },
